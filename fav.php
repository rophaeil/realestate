...
<?php
  ...
  $id = $fav[$i]['property_id'];
  $record = $prop->findby('id' , $id);
  $fav_list=[];
  array_push($fav_list,$record);
                              ...
                              <div class="property-entry h-100 mb-3">
                                <a href="property-details.php" class="property-thumbnail">
                                  <div class="offer-type-wrap">
                                    <span class="offer-type bg-danger"><?php echo $record[$i]['title']?></span>
                                  </div>
                                  <img src="layout/img/slid4.jpg" alt="Image" class="img-fluid">
                                </a>
                            ...
                            <div class="card-body">
                              <div class="property-entry h-100 mb-3">
                                <a href="property-details.php" class="property-thumbnail">
                                  ...
                                  <img src="layout/img/slider3.jpg" alt="Image" class="img-fluid">
                                </a>
                                <div class="p-4 property-body">
                                  <a href="#" class="property-favorite" style="background-color: #f23a2e;"><i class="fa-regular fa-heart" style="color: white;"></i></span></a>
                                  <h2 class="property-title"><a class="address" href="property-details.php">625 Shokolani St</a></h2>
