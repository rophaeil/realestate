              ...
              <div class="row">
                  <div class="col-lg-4 col-md-6">
                    <div class="box quality">
                        <div class="img-holder"><img src="../beetcom/layout/img/slid2.jpg" alt="" /></div>
                        <h2>Silver</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">Choose Plan</button>
        ...
        <form>
          ...
          <div class="mb-3">
            <select id="defaultSelect" class="form-select">
              ...
              <option value="2">Shobra</option>
              <option value="3">Salam</option>
            </select>
          </div>
          <div class="form-group mt-3">
            <input type="text" id="phone" class="form-control" placeholder="Address">
          </div>
          <div class="form-group mt-3">
            <input type="tel" id="phone" class="form-control" placeholder="Phone">
          </div>
          <div class="form-group mt-3">
            <input type="email" id="phone" class="form-control" placeholder="Email">
          </div>
        </form>
      </div>
        ...
        <button type="button" class="btn btn-primary">Send message</button>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="box passion">
                        ...
                        <h2>Platinum</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit harum hic veniam eligendi minima</p>
                        <button type="button" id="btn-plat" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">Choose Plan</button>
